...
//restaurant routes
//index
Route::get('/restaurants', [Restaurant::class, 'index'])->name('restaurants-index')->middleware('rp:admin') ;
//create
...
//menu routes
//index
Route::get('/menus', [Menu::class, 'index'])->name('menus-index')->middleware('rp:admin') ;
//create
...
//dish routes
//index
Route::get('/dishes', [Dish::class, 'index'])->name('dishes-index')->middleware('rp:admin') ;
//create
